...
pkg install -y openssl php56-json php56-phar php56-filter php56-hash php56-openssl php56-ctype
pkg install -y npm
npm install -g bower
...
sed -r -n -i ' ' "s/^;date\.timezone =.*/date\.timezone = America\/Vancouver/" /usr/local/etc/php.ini
